...
var profilTest = Profil(nom: "Albert Dupont", description: "J'ai un appareil à réparer avec la piéce de rechange mais je ne sais comment m'y prendre. J'aimerais qu'on puisse me donner un coup de main :)", disponibilite: .semaine, appareils: [appareils[0]], annoncesReparation: [], annonceReparateur: nil, image: Image("profil2"), competence: [CompetenceAppareil.ordinateur: 3, CompetenceAppareil.smartphone: 2])
